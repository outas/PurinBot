...
class _PriconneData:
    ...
    CHARA = {
        ...
        1128: ["真阳(游骑兵)", "マヒル(レンジャー)", "Mahiru(Ranger)", "骑兵奶牛", "骑兵🐄", "骑兵🐮", "骑兵真☀", "游侠奶牛", "游侠🐄", "游侠🐮", "游侠真☀"],
        1130: ["步未(奇境)", "アユミ(ワンダー)", "Ayumi(Wannda)", "奇境步美"],
        ...
        1805: ["可可萝(公主)", "コッコロ(プリンセス)", "Kokkoro(Princess)", "公主妈", "公主可可", "公主白", "公白", "公主可可萝"],
